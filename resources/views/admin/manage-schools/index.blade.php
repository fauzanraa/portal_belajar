                ...
                <tbody>
                    @foreach ($data_sekolah as $data)
                        <tr>
                            ...
                            <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$data->name_school}}</td>
                            <td>{{$data->address}}</td>
                            <td>{{$data->email}}</td>
                            <td class="flex gap-2">
                                @php
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                    ...
                    <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="add-school-modal">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{route('store-schools')}}" method="POST">
                        @csrf
                        <div>
                            <label for="school_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sekolah</label>
                        ...
                        <div>
                            <label for="school_address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat Sekolah</label>
                        ...
                        <div>
                            <label for="school_email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat Email</label>
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ route('update-schools') }}" method="POST">
                        ...
                        <div>
                            <label for="school_name_edit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sekolah</label>
                        ...
                        <div>
                            <label for="school_address_edit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat Sekolah</label>
                        ...
                        <div>
                            <label for="school_email_edit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat Email</label>
