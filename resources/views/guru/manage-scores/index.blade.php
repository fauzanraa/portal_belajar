...
@section('content')
    ...
    <div class="mt-10 rounded-tl-xl bg-white p-5 pl-4 md:pl-8">
        <div class="space-y-4 p-4 sm:p-5 md:pl-8">
            @foreach ($sessionMeeting as $session)
                <div class="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden">
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div class="relative bg-gradient-to-r from-sky-500 to-indigo-600 p-6 text-white w-full lg:w-80">
                            ...
                            <!-- Judul dan Deskripsi -->
                            <h5 class="text-xl font-bold mb-2 leading-tight">
                        ...
                        <!-- RIGHT: Action Area -->
                        <div class="flex-1 p-6">
                            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center h-full gap-4 lg:gap-0">

                                {{-- Bisa ditambahkan konten tambahan di sini jika perlu --}}
