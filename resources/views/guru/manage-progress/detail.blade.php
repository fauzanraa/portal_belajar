                    ...
                    <div class="px-6 py-5">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-6">
                                ...
                                @if ($data->status == 'finished')
                                    <button onclick="window.location.href='{{route('summary-progress', $encryptedSession)}}'"  class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-3 md:group-hover:translate-x-0 transition-all duration-300">
