    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-4">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-white">List Nilai</h2>
                </div>
            </div>
            <div class="text-right">
                <div class="text-yellow-300 text-sm font-medium">Total Pertemuan</div>
            ...
            <div class="px-6 py-5">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="relative">
                            <div class="w-16 h-16">
                                <svg class="w-16 h-16 transform -rotate-90" viewBox="0 0 36 36">
                                    ...
                                    <path class="text-red-500" stroke="currentColor" stroke-width="3" fill="none" stroke-dasharray="20, 100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"></path>
                                </svg>
                        ...
                        <!-- Details Button -->
                        <button onclick="openModal()"  class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-300">
                ...
                <div class="mt-4 hidden group-hover:block transition-all duration-300">
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div class="text-center">
                                <div class="text-2xl font-bold text-green-600">1/1</div>
                                <div class="text-xs text-gray-600">Quiz Selesai</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-purple-600">20</div>
                                <div class="text-xs text-gray-600">Nilai</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        {{-- <p class="text-sm text-gray-600">Multiple Choice • 10 Soal</p> --}}
                                ...
                                <div class="text-right">
                                    ...
                                    {{-- <div class="text-sm text-gray-500">8/10 benar</div> --}}
                                </div>
                            </div>
