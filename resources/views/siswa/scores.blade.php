                    ...
                    <div class="px-6 py-5">
                        <div class="flex items-center justify-between">
                            ...
                            {{-- @php
                                ...
                                $encryptedTask = Illuminate\Support\Facades\Crypt::encrypt(
                                ...
                                <div class="relative">
                                    <div class="w-16 h-16">
                                        <svg class="w-16 h-16 transform -rotate-90" viewBox="0 0 36 36">
                                            ...
                                            <path class="text-green-500" stroke="currentColor" stroke-width="3"
                                        ...
                                        <div class="absolute inset-0 flex items-center justify-center">
                                            <span
                                                class="text-lg font-bold text-green-500">100</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="group hover:bg-blue-50 transition-all duration-300 cursor-pointer">
                            <div class="px-6 py-5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-6">
                                        <button
                                            onclick="window.location.href='{{ route('summary', ['idTask' => $encryptedTask, 'from' => 'list-scores']) }}'"
                                        ...
                                        <div class="relative">
                                            <div class="w-16 h-16">
                                                <svg class="w-16 h-16 transform -rotate-90" viewBox="0 0 36 36">
                                                    ...
                                                    <path class="{{ $colorClass }}" stroke="currentColor" stroke-width="3"
                                                        fill="none" stroke-dasharray="{{ $completed->posttest_score }}, 100"
                                                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831">
                                                    </path>
                                                </svg>
                                                <div class="absolute inset-0 flex items-center justify-center">
                                                    <span
                                                        class="text-lg font-bold {{ $colorClass }}">{{ $completed->posttest_score }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-4 hidden group-hover:block transition-all duration-300">
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <div class="grid grid-cols-2 gap-4">
                                            <div class="text-center">
                                                <div class="text-2xl font-bold text-blue-600">
                                                    {{ $completed->completed_tasks }}/{{ $completed->total_tasks }}</div>
                                                <div class="text-xs text-gray-600">Tugas</div>
                                            </div>
                                            <div class="text-center">
                                                <div class="text-2xl font-bold text-green-600">
                                                    {{ $completed->material->count() }}/{{ $completed->material->count() }}
                                                </div>
                                                <div class="text-xs text-gray-600">Materi</div>
                                            </div>
                                        </div>
            ...
            @else
                <div class="flex justify-center items-center min-h-[400px] p-6">
                    <div class="max-w-md w-full">
                        <div
                            class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden transform hover:scale-105 transition-all duration-300">
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-100 px-8 py-6 text-center">
                                <div class="relative">
                                    <div
                                        class="w-20 h-20 mx-auto bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full flex items-center justify-center mb-4 shadow-lg">
                            ...
                            <div class="px-6 py-4 text-center">
                                ...
                                <p class="text-gray-600 leading-relaxed text-xs my-6">
