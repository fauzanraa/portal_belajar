            ...
            <div class="w-full bg-white mt-10 rounded-l-xl shadow-lg border border-gray-200">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white rounded-t-xl">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h1 class="text-xl font-bold">Tugas Modul 1</h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-l-4 border-green-500">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-green-700 mt-2">75</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-l-4 border-blue-500">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-blue-700 mt-2">05:00</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 border-l-4 border-orange-500">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-orange-700 mt-2">25%</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border-l-4 border-purple-500">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xm font-bold text-purple-700 mt-2">Hasil yang kamu dapatkan sudah baik, terus tingkatkan hasilmu!</p>
                                </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        ...
                        <div class="bg-white rounded-lg border border-gray-300 p-6 mb-6">
                            ...
                            <div class="text-gray-700 leading-relaxed">
                                <p id="current-question">
                                    Komponen ini berfungsi untuk menandai titik awal dan titik akhir dari suatu algoritma atau program. Komponen ini menunjukkan di mana proses dimulai dan di mana proses berakhir. Tanpa komponen ini, flowchart tidak memiliki batas yang jelas.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <button class="question-nav-btn w-10 h-10 rounded-lg border-2 font-semibold transition-all duration-200 bg-blue-500 text-white border-blue-500">
                                    1
                                </button>
                                <button class="question-nav-btn w-10 h-10 rounded-lg border-2 font-semibold transition-all duration-200 bg-white text-gray-600 border-gray-300 hover:border-blue-400 hover:text-blue-600">
                                    2
                                </button>
                            </div>
                        </div>
                            ...
                            <div id="comparisonView" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div class="bg-white rounded-lg border-2 border-blue-300 p-4">
                                    ...
                                    <div class="min-h-[350px] bg-blue-50 rounded-lg flex items-center justify-center" id="student-flowchart">
                                        <img src="{{ asset('storage/assets/flowcharts/keyAnswers/imgAnswer6_1751887300.png') }}" 
                                            alt="Flowchart Siswa" 
...
@section('script')
@if (Auth::user()->userable->name !== 'user')
    <script>
