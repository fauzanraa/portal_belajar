    ...
    public function storeQuestion($id, Request $request){
        ...
        try {
            ...
            for ($i=0; $i < $request->total_question; $i++) { 
                ...
                $promptIntro = "Buatkan satu node flowchart dari studi kasus berikut. Komponen yang dimaksud cukup satu node sesuai konteks, tanpa perlu menyambungkan node lain. Formatkan dalam JSON GoJS yang lengkap. Soal: {$question->question}";
